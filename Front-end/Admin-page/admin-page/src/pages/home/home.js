        ...
        <div className="row">
            ...
            <div className="col-lg-3 col-md-6 d-flex align-items-stretch">
              <div className="member" data-aos="fade-up" data-aos-delay="100">
                ...
                <div className="member-img">
                  <img src={docData1["Card-Img"][0]} style={{ height: 240 }} className="img-fluid" alt="" />
                ...
                <div className="member-info">
                  <h4>{docData1["Card-Body"][0]}</h4>
                  <ListGroup className="list-group-flush">
                    {docData1["ListInformation"].map((item, index) => (
                      <ListGroup.Item style={{padding: '0.5rem 1.15rem'}} key={index}><i className="bi bi-door-open"></i> {item}</ListGroup.Item>
                    ))}
                  </ListGroup>
                  <br/>
          ...
          {docData2 && (
            <div className="col-lg-3 col-md-6 d-flex align-items-stretch">
              <div className="member" data-aos="fade-up" data-aos-delay="100">
                <div className="member-img">
                  <img src={docData2["Card-Img"][0]} style={{ height: 240 }} className="img-fluid" alt="" />
                  <div className="social">
                    <a href=""><i className="bi bi-twitter"></i></a>
                    <a href=""><i className="bi bi-facebook"></i></a>
                    <a href=""><i className="bi bi-instagram"></i></a>
                ...
                <div className="member-info">
                  <h4>{docData2["Card-Body"][0]}</h4>
                  <ListGroup className="list-group-flush">
                    {docData2["ListInformation"].map((item, index) => (
                      <ListGroup.Item style={{padding: '0.5rem 1.15rem'}} key={index}><i className="bi bi-door-open"></i> {item}</ListGroup.Item>
                    ))}
                  </ListGroup>
                  <br/>
          ...
          {docData3 && (
            <div className="col-lg-3 col-md-6 d-flex align-items-stretch">
              <div className="member" data-aos="fade-up" data-aos-delay="100">
                <div className="member-img">
                  <img src={docData3["Card-Img"][0]} style={{ height: 240 }} className="img-fluid" alt="" />
                  <div className="social">
                    <a href=""><i className="bi bi-twitter"></i></a>
                    <a href=""><i className="bi bi-facebook"></i></a>
                    <a href=""><i className="bi bi-instagram"></i></a>
                ...
                <div className="member-info">
                  <h4>{docData3["Card-Body"][0]}</h4>
                  <ListGroup className="list-group-flush">
                    {docData3["ListInformation"].map((item, index) => (
                      <ListGroup.Item style={{padding: '0.5rem 1.15rem'}} key={index}><i className="bi bi-door-open"></i> {item}</ListGroup.Item>
                    ))}
                  </ListGroup>
                  <br/>
          ...
          {docData4 && (
            <div className="col-lg-3 col-md-6 d-flex align-items-stretch">
              <div className="member" data-aos="fade-up" data-aos-delay="100">
                <div className="member-img">
                  <img src={docData4["Card-Img"][0]} style={{ height: 240 }} className="img-fluid" alt="" />
                  <div className="social">
                    <a href=""><i className="bi bi-twitter"></i></a>
                    <a href=""><i className="bi bi-facebook"></i></a>
                    <a href=""><i className="bi bi-instagram"></i></a>
                ...
                <div className="member-info">
                  <h4>{docData4["Card-Body"][0]}</h4>
                  <ListGroup className="list-group-flush">
                    {docData4["ListInformation"].map((item, index) => (
                      <ListGroup.Item style={{padding: '0.5rem 1.15rem'}} key={index}><i className="bi bi-door-open"></i> {item}</ListGroup.Item>
                    ))}
                  </ListGroup>
                  <br/>
      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-lg-12 col-md-6">
            <div className="box" data-aos="zoom-in-right" data-aos-delay="200">
              <h3>Build your own building</h3>
              <h4><sup>+</sup>3<span> Building types</span></h4>
              <ul>
                <li>Count price</li>
                <li>With your order</li>
                <li>Feel free to choose</li>
                <li className="na">Rough combo</li>
                <li className="na">Package combo</li>
              </ul>
